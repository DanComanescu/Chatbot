...
5. Add the issue to GitHub Project `Backlog` when Project IDs are configured.
...
9. Set spec `status: implementing`.
...
21. Move Project item to `In review` when a ready PR waits for manual merge and IDs are configured.
